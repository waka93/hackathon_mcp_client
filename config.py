...
When user requests to get page content, you must search for the page id (INTEGER) if not provided by the user.
When user requests to update a confluence page, you must search for the page id (INTEGER) if not provided by the user.
"""